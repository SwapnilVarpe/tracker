...
class NewEntryNotifier extends StateNotifier<NewEntryState> {
  ...
  NewEntryNotifier({required this.entryId}) : super(NewEntryState.loading()) {
    _init();
  }
...
final categoryStateProvider =
    StateNotifierProvider.family<NewEntryNotifier, NewEntryState, String>(
        (ref, id) {
  return NewEntryNotifier(entryId: id);
});
